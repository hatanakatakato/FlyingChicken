...
public class AdMobInterstitialScript : MonoBehaviour
{
    ...
    //3.HandleOnAdLoaded()で広告が終了した後に実行される関数を指定(シーン移動など)
...
#if UNITY_ANDROID
        string adUnitId = "ca-app-pub-7122963741657645/3417408477";//ここにAndroidのインタースティシャル広告IDを入力

#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-7122963741657645/6335409379";//ここにiOSのインタースティシャル広告IDを入力
